...
class Terkey:
  ...
  def banner(self):
      ...
      print(f'{a}Profesor Acc'.center(53))
  ...
  def about(self):
    ...
    A program from {a}Profesor Acc{c} for you.
    ...
    {a}https://t.me/Prof_acc{c}
    My Web Site
    {a}https://www.Profesoracc.com{c}
    And if you want to give me some money, you can visit
    {a}https://trakteer.id/ProfesorAcc{c}
  ...
  {a}3.{c} About
    ...
    if menu == "1":
      ...
      pass
    #print(c+'Silahkan hubungi '+a+'https://t.me/Prof_acc'+c+' jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
